...
public class AddDefinitionFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Spinner spinner = (Spinner)view.findViewById(R.id.new_word_part_of_speech_spinner);
        ArrayAdapter<CharSequence> arrayAdapter = ArrayAdapter.createFromResource(this.getActivity(),R.array.type_of_part_of_speech,android.R.layout.simple_spinner_item);
